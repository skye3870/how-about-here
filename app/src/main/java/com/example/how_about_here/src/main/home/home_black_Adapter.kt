...
class HomeBlackAdapter(private val HomeBlackArr: ArrayList<HomeBlack>) :RecyclerView.Adapter<HomeBlackAdapter.CustomViewHolder>(){


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CustomViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.home_hotel_black_list_item, parent, false)//뷰를 붙여줌
    ...
    override fun onBindViewHolder(holder: CustomViewHolder, position: Int) {//계속실행
        ...
        holder.img.setImageResource(HomeBlackArr.get(position).img as Int)
